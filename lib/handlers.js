...
handlers.index = (data, cb) => {
    ...
    if(data.method == 'get')
    {
        ...
        let templateData= {
            'head.title' : 'Uptime Monitoring - A Simplicidade no monitoramento',
            'head.description' : 'Oferecemos monitoramento simples do uptime para sites HTTP / HTTPS de todos os reis. Quando o site for desativado, enviaremos um texto para que você saiba.',
            'body.class' : 'index'
        }
...
handlers.accountCreate = (data, cb) => {
     ...
     if(data.method == 'get')
     {
         ...
         let templateData= {
             ...
             'head.description' : 'Crie sua conta é fácil e leva apenas alguns segundos.',
...
handlers.sessionCreate = (data, cb) => {
    ...
    if(data.method == 'get')
    {
        // Prepare data for interpolation
        let templateData= {
            'head.title' : 'Faça login na sua conta',
            'head.description' : 'Digite seu número de telefone e senha para acessar sua conta.',
...
handlers.sessionDeleted = (data, cb) => {
    ...
    if(data.method == 'get')
    {
        ...
        let templateData= {
            ...
            'head.description' : 'Você saiu da sua conta.',
