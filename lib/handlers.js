...
handlers.index = (data, cb) => {
    ...
    if(data.method == 'get')
    {
        ...
        let templateData= {
            ...
            'head.description' : 'We offer free, simple uptime monitoring fort HTTP/HTTPS sites of all kings. When your siet goes down, we`ll send you a text to let you know.',
            'body.class' : 'index'
        }
